...
class WeatherStation {
  ...
  // 1. processWeatherData using destructuring
  ...
  // 2. mergeStationData using spread operator
  ...
  // 3. createWeatherSummary with destructuring
  ...
  // 4. updateReadingBatch using spread
